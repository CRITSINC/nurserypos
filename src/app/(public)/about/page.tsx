...
function About() {
    return (
        <>
            <Layout parent="About" parent_link="/about">
            <div className="container  pt-50">
                    <div className="row">
                        <div className="col-xl-10 col-lg-12 m-auto">
                            <section className="row align-items-center mb-50">
                                <div className="col-lg-6">
                                    <img src="/assets/imgs/page/About-us.png" alt="nest" className="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4" />
                                </div>
                                <div className="col-lg-6">
                                    <div className="pl-25">
                                        <h2 className="mb-30">Welcome to Glen Echo Nurseries</h2>
                                        <p className="mb-25">Glen Echo Nurseries is a long-established garden centre located in the heart of Caledon, Ontario.</p>
                                        <p className="mb-50">We have a proud history as a leader in the garden centre industry and we look forward to providing our continued excellence in products and service.</p>
                                        <p className="mb-50">We welcome you to explore our endless possibilities for your own garden paradise. You can look forward to a simple, yet informative shopping experience as we assist you in discovering quality plant materials and garden products ideally suited to you.</p>
                                        <p className="mb-50">Our friendly and knowledgeable staff are here to help you inspire your inner gardener.</p>
                                    </div>
                                </div>
                            </section>
