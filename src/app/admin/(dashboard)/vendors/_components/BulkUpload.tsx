...
export default function UploadBulk({
  ...
  const processFile = async (
    ...
    try {
      ...
      toast.success(
        `${parsedData.length} vendors loaded successfully.`
      );
...
const handleSave = async () => {
  ...
  toast.success(
    `${jsonData.length} vendors ready for bulk upload.`
  );
};
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-muted-foreground">
                      Contains all supported vendor fields.
                    </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-0.5 flex items-center gap-1 text-xs text-green-700">
                          ...
                          {jsonData.length} vendors detected
