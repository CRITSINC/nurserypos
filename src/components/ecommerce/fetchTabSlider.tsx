...
// import { fetchByCatagory } from "../../redux/services/product.service";
...
function FeatchTabSlider() {
    ...
    const featuredProduct = async () => {
        ...
        const featuedItem = allProducts.filter((item:any) => item.featured);
    ...
    const trendingProduct = async () => {
        const request = await fetch("/static/product.json");
        const allProducts = await request.json();
        const trendingItem = allProducts.filter((item:any) => item.trending);
    ...
    const newArrivalProduct = async () => {
        const request = await fetch("/static/product.json");
        const allProducts = await request.json();
        const newArrivalItem = allProducts.sort(function (a:any, b:any) {
